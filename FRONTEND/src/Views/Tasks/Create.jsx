...
const TasksCreate = () => {
  ...
  // Datos del usuario actual y navegación
  ...
  // Funciones para obtener y gestionar usuarios
  ...
  const createTask = async (e) => {
    ...
    try {
      const res = await sendRequest('POST', form, '/tasks', '/tasks', true, "Tarea Creada Correctamente")
      if (res) {
        go('/tasks')
      }
    } catch (error) {
                ...
                <form onSubmit={createTask}>
                  ...
                  <div className='d-grid col-10 mx-auto'>
                    <button className='btn btn-dark'>
                      <i className='fa-solid fa-circle-plus'></i> Crear Tarea
                    </button>
                  </div>
                </form>
              </div>
